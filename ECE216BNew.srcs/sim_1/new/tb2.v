...
valid = 0;
configIn =7'b0000000; 
controlIn =36'b110110110000100100000000000000000000; 
inputData = {configIn, controlIn};
#2
configIn =7'b0100100; //36
controlIn =36'b001000000000001000000000000000000000; 
inputData = {configIn, controlIn};
#2
configIn =7'b1101000; 
controlIn =36'b000001001000010000000000000000000000; 
inputData = {configIn, controlIn};
#2
configIn =7'b0000001; 
controlIn =36'b000000000100000011000000111100000000; 
inputData = {configIn, controlIn};
#2
configIn =7'b0100010; 
controlIn =36'b000000000011000000111100000000000000; 
inputData = {configIn, controlIn};
#2
//configIn =7'b0000000; 
