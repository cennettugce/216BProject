...
//Date        : Mon May 13 21:32:37 2024
//Host        : DESKTOP-TUIN670 running 64-bit major release  (build 9200)
//Command     : generate_target MEM_Design.bd
//Design      : MEM_Design
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "MEM_Design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=MEM_Design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "MEM_Design.hwdef" *) 
module MEM_Design
   (ComputeDataIn,
    clk,
    dataOut,
  ...
  MEM_Design_ArrayTop_0_0 ArrayTop_0
       (.clk(clk_1),
  ...
  MEM_Design_CADA_MEMControl_0_0 CADA_MEMControl_0
       (.DataIn(inputData_1),
        ...
        .valid(valid_1),
        .writeEn(writeEn_1));
  MEM_Design_blk_mem_gen_0_0 blk_mem_gen_0
