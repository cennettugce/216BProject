...
#
# Script generated by Vivado on Mon May 27 01:42:04 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Project_Design.sh
...
#
# Usage        : Project_Design.sh
#                Project_Design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Project_Design.sh [-reset_run]
#                Project_Design.sh [-reset_log]
#                Project_Design.sh [-help]
#
...
# script info
echo -e "Project_Design.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Project_Design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_7 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Project_Design xil_defaultlib.Project_Design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Project_Design -key {Behavioral:sim_1:Functional:Project_Design} -tclbatch cmd.tcl -protoinst "protoinst_files/Project_Design.protoinst" -protoinst "protoinst_files/MEM_Design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Project_Design.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Project_Design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Project_Design.sh [-help]\n\
Usage: Project_Design.sh [-step]\n\
Usage: Project_Design.sh [-lib_map_path]\n\
Usage: Project_Design.sh [-reset_run]\n\
Usage: Project_Design.sh [-reset_log]\n\
Usage: Project_Design.sh [-keep_index]\n\
Usage: Project_Design.sh [-noclean_files]\n\n\
