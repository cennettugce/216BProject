...
#                script (type 'Project_Design.sh -help' for more information).
#
...
design_libs=(xpm xil_defaultlib blk_mem_gen_v8_4_7)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Project_Design xil_defaultlib.glbl -o Project_Design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Project_Design_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Project_Design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Project_Design_simv.daidir vcs_lib c.obj)
