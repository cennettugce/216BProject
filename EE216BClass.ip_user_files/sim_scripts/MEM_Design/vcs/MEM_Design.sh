...
#                script (type 'MEM_Design.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.MEM_Design xil_defaultlib.glbl -o MEM_Design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./MEM_Design_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key MEM_Design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc MEM_Design_simv.daidir vcs_lib c.obj)
