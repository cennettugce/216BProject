...
#
# Script generated by Vivado on Wed May 29 19:47:36 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : MEMDesign.sh
...
#
# Usage        : MEMDesign.sh
#                MEMDesign.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MEMDesign.sh [-reset_run]
#                MEMDesign.sh [-reset_log]
#                MEMDesign.sh [-help]
#
...
# script info
echo -e "MEMDesign.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MEMDesign.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MEMDesign xil_defaultlib.MEMDesign xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim MEMDesign -key {Behavioral:sim_1:Functional:MEMDesign} -tclbatch cmd.tcl -protoinst "protoinst_files/MEMDesign.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MEMDesign.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MEMDesign.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MEMDesign.sh [-help]\n\
Usage: MEMDesign.sh [-step]\n\
Usage: MEMDesign.sh [-lib_map_path]\n\
Usage: MEMDesign.sh [-reset_run]\n\
Usage: MEMDesign.sh [-reset_log]\n\
Usage: MEMDesign.sh [-keep_index]\n\
Usage: MEMDesign.sh [-noclean_files]\n\n\
